<div class="container">
    ...
    <hr class="my-2">
    <form class="form-horizontal row" action="<?php echo Helpers::redirect("account/exSignUp"); ?>" method="post">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="dn">Display name</label>
                <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <button class="btn btn-primary btn-lg" id="btnRegister" role="button" type="submit">Register</button>
